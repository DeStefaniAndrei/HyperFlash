...
export class ClientV2 {
    ...
    buildFillExtcallStorageTransactions(sourceChain, totalLength, chunks, storageKey, accounts, priorityFee) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const chunk of chunks) {
                if (chunk.offset === 0) {
                    result.init = {
                        instructions: newTxWithOptionalPriorityFee(initPriorityFee).add(yield instructions
    ...
    prepareExternalCallTransactions(storageKey, sourceChain, data, accounts, priorityFee) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (accounts.externalCallMeta) {
                ...
                if (!isExtCallMetaAccumulation((_g = decodedExtCallMeta === null || decodedExtCallMeta === void 0 ? void 0 : decodedExtCallMeta.data) !== null && _g !== void 0 ? _g : null)) {
                    ...
                    else if (data.equals((_j = accounts.externalCallStorage.data) === null || _j === void 0 ? void 0 : _j.slice(EXT_CALL_STORAGE_OFFSET))) {
    ...
    tryPackCalldataTransaction(ixs, extCallTxs) {
        var _a;
        const result = new Transaction().add(...ixs.prefix);
        if (extCallTxs) {
    ...
    buildSendContext(sender, tokenMint, chainTo, externalCall, options) {
        ...
        const [externalCallStorage] = this.accountsResolver.getExternalCallStorageAddress(shortcut, sender, crypto.normalizeChainId(constants.SOLANA_CHAIN_ID));
    ...
    buildSendTransactions(sender, amount, receiverInfo, senderInfo, autoParams, options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (externalCallExists) {
                ...
                extCallTxs = yield this.prepareExternalCallTransactions(externalCallShortcut, constants.SOLANA_CHAIN_ID, externalCallData, {
                    executor: sender,
