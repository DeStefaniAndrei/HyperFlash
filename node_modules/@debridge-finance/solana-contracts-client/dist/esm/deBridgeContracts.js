    ...
    getSubmissionStatus(submissionId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const transactions = yield this._connection.getConfirmedSignaturesForAddress2(extCallMeta, { limit: 100 });
    ...
    */
    ...
    buildInitializeSendBridgeTransaction(tokenMint, payer) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const bridgeId = helpers.hexToBuffer(crypto.hashDebridgeId(constants.SOLANA_CHAIN_ID, tokenMint.toBuffer()));
    ...
    buildSendContext(sender, sendFromWallet, tokenMint, receiver, chainIdTo, useAssetFee, fallbackAddress, flags, data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [externalCallStorage] = this.accountsResolver.getExternalCallStorageAddress(externalCallShortcut, sender, crypto.normalizeChainId(constants.SOLANA_CHAIN_ID));
            const [externalCallMeta] = this.accountsResolver.getExternalCallMetaAddress(externalCallStorage);
            const accounts = {
                bridgeCtx: {
                    bridge,
    ...
    buildSendInstruction(sender, sendFromWallet, payableAmount, tokenMint, receiver, chainIdTo, useAssetFee, referralCode, fallbackAddress, flags, executionFee, data, checkSenderBalance = true, sendFromWalletMayNotExist = false) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (data && !checkFlag(flags, SEND_HASHED_DATA)) {
                exTxs = yield this.prepareExtCallTransactions(externalCallShortcut, constants.SOLANA_CHAIN_ID, sender, data, {
            ...
            if (exTxs.init) {
                const sizeCheckTx = new Transaction().add(result).add(sendIx);
                sizeCheckTx.add(...exTxs.init.instructions);
                const txSize = txs.getTransactionSize(sizeCheckTx);
                logger.debug(`[sendIx] Concat tx size: ${txSize !== null && txSize !== void 0 ? txSize : "too big"}, ${txSize ? constants.MAX_TX_SIZE - txSize : ""}`);
                if (txSize != null && txSize <= 1230) {
    ...
    hashSubmissionId(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (isMintBridge(bridgeData)) {
                ...
                debridgeId = helpers.hexToBuffer(crypto.hashDebridgeId(constants.SOLANA_CHAIN_ID, nativeTokenAddress)); // correct
            }
            else {
                throw new Error(`Bridge not supported!`);
            }
            const subId = crypto.hashSubmissionIdRaw({
                ...
                targetChainId: constants.SOLANA_CHAIN_ID,
     ...
     */
    buildInitExternalCallInstruction(submissionId, sourceChainId, executor, calculatedAccounts, data, fullDataSize, priorityFee) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            executor = new PublicKey(executor);
            ...
            const ix = yield instructions
                ...
                rawInstructions: data ? data : Buffer.from([]),
            })
                .instruction();
     ...
     */
    buildExtendExternalCallStorageInstruction(submissionId, sourceChainId, executor, data, calculatedAccounts, priorityFee) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            executor = new PublicKey(executor);
            const subIdBuffer = isBuffer(submissionId) ? submissionId : helpers.hexToBuffer(submissionId);
    ...
    prepareExtCallTransactions(submissionId, sourceChainId, executor, data, calculatedAccounts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [extCallStorage] = (calculatedAccounts === null || calculatedAccounts === void 0 ? void 0 : calculatedAccounts.storage)
                ? [calculatedAccounts.storage]
                : this.accountsResolver.getExternalCallStorageAddress(isBuffer(submissionId) ? submissionId : helpers.hexToBuffer(submissionId), executor, chainId);
            const [extCallMeta] = (calculatedAccounts === null || calculatedAccounts === void 0 ? void 0 : calculatedAccounts.meta)
                ? [calculatedAccounts.meta]
                : this.accountsResolver.getExternalCallMetaAddress(extCallStorage);
            ...
            if (storedData === null) {
                ...
                const transactions = [];
                const initExtCall = yield this.buildInitExternalCallInstruction(submissionId, chainId, executor, {
                    meta: extCallMeta,
                    storage: extCallStorage,
                }, (firstChunk === null || firstChunk === void 0 ? void 0 : firstChunk.data) || Buffer.from([]), totalSize);
                for (const chunk of dataChunks) {
                    transactions.push(yield this.buildExtendExternalCallStorageInstruction(submissionId, sourceChainId, executor, chunk, {
                        extCallStorage,
                        extCallMeta,
                    }));
                }
                return Object.assign(Object.assign({}, result), { init: { instructions: initExtCall.instructions, payer: executor }, store: transactions });
            }
            else {
                ...
                if (storedData === null || storedData === void 0 ? void 0 : storedData.data.slice(EXT_CALL_STORAGE_OFFSET).equals(data)) {
                    ...
                    while (offset < data.length) {
                        ...
                        if (!onChainData.slice(...range).equals(correctChunk)) {
                            ...
                            const updateExtCallIx = yield this.buildExtendExternalCallStorageInstruction(submissionId, sourceChainId, executor, { data: correctChunk, offset }, {
                                extCallMeta,
                                extCallStorage,
                            });
    ...
    storeExternallCall(extCallTransactions, sender, data, overwriteOnError = false) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (extCallTransactions.init) {
                ...
                let retries = 0;
                if (!onChainData) {
                    const [initId] = yield sender(extCallTransactions.init);
                    logger.debug(`Initialize extCall id: ${initId}`);
                    result.push(initId);
                    const isEmpty = (acc) => (acc === null ? true : acc.lamports === 0);
                    for (;;) {
                        const [meta, storage] = yield this._connection.getMultipleAccountsInfo([metaAccount, storageAccount]);
    ...
    storeExternalCallV2(extCallTransactions, data, submissionState, sender, options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((_c = (_b = submissionState.externalCallStorage) === null || _b === void 0 ? void 0 : _b.isEmpty) !== null && _c !== void 0 ? _c : true) {
                ...
                result.push(initId);
                try {
                    storedFullDataInAllocTx = yield allocPromise;
                }
                catch (e) {
                    logger.error(e);
    ...
    buildClaimTransaction(executor, amount, receiverInfo, senderInfo, submissionInfo, autoParams, createMissingWallets, confirmationStorageCreator, priorityFee) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (exTxs.init) {
                const sizeCheckTx = new Transaction().add(result).add(claimInstr);
                sizeCheckTx.add(...exTxs.init.instructions);
                try {
                    const txSize = txs.getTransactionSize(sizeCheckTx);
                    logger.debug(`[claimIx] Concat tx size: ${txSize !== null && txSize !== void 0 ? txSize : "too big"}, space left: ${txSize ? constants.MAX_TX_SIZE - txSize : ""}`);
                    if (txSize != null && txSize <= 1230) {
                        result.add(...exTxs.init.instructions);
