...
import { ActionPriorityFee, AutoParamsType, ChainIdType, ExtCallTransactions, HexString, PriorityFeeConfig, SolanaPubkey, WalletsCheckConfig, AccountStructByName } from "./interfaces";
...
export declare class ClientV2 {
    ...
    prepareExternalCallTransactions(storageKey: Buffer, sourceChain: number | Buffer, data: Buffer, accounts: {
        ...
        init?: ActionPriorityFee;
        store?: ActionPriorityFee;
    }): Promise<ExtCallTransactions | null>;
    /**
    ...
    buildSendTransactions(sender: SolanaPubkey, amount: bigint | number, receiverInfo: {
        ...
        extCallTxs: ExtCallTransactions | null;
