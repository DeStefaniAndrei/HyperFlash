...
export declare class DeBridgeSolanaClient {
    ...
    private _wallet;
    private _provider;
    private walletProvided;
    private feeBeneficiarAccount;
    private debug;
    private associatedTokenProgramId;
    private priorityFeeConfig;
    constructor(connection: Connection, wallet?: helpers.Wallet | Wallet, params?: {
    ...
    updateWalletAndConnection(newConnection: Connection, newWallet: Wallet): void;
     ...
     */
    buildInitExternalCallInstruction(submissionId: string | Buffer, sourceChainId: ChainIdType, executor: SolanaPubkey, calculatedAccounts: {
        meta?: PublicKey;
        storage?: PublicKey;
    }, data?: Buffer, fullDataSize?: number, priorityFee?: ActionPriorityFee): Promise<NonCompiledTransaction>;
    /**
     ...
     */
    buildExtendExternalCallStorageInstruction(submissionId: HexString | Buffer, sourceChainId: ChainIdType, executor: SolanaPubkey, data: DataChunk, calculatedAccounts?: {
    ...
    get wallet(): Pick<helpers.Wallet, "publicKey" | "signAllTransactions" | "signTransaction">;
