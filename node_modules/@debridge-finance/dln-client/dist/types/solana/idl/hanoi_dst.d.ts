export type DlnDst = {
    ...
    instructions: [
        ...
        },
        {
            ...
            docs: [
                ...
                "",
                "# Args",
                "* `unvalidated_order` - Full order for fulfill",
                "* `order_id` - identificator of order",
                "* `unlock_authority` - specify an address that can later make a `send_unlock`. The default is to use taker",
                "",
                "# Allowed",
    ...
    errors: [
        ...
        {
            code: 6036;
            name: "ExtcallWalletAlreadyUsed";
        },
        {
            code: 6037;
            name: "WrongExtcallAuthOwner";
        },
        {
            code: 6038;
...
export declare const IDL: DlnDst;
//# sourceMappingURL=hanoi_dst.d.ts.map