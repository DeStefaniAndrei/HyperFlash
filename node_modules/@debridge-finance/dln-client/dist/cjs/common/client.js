...
exports.CommonDlnClient = void 0;
...
class CommonDlnClient {
    ...
    getClient(chain) {
        const engine = (0, common_types_1.getEngineByChainId)(chain);
        const client = this.clients.get(engine);
        if (!client)
            throw new client_error_error_1.ClientError(client_error_type_enum_1.ClientErrorType.ClientMissing, `Client for chain ${chain} (engine ${engine}) is missing`);
        return client;
    }
    setClient(client) {
        this.clients.set(client.getEngine(), client);
    ...
    async getTakerFlowCostForSingleOrder(params, payload) {
        ...
        if (params.batchUnlockCoverage < 0.1 || params.batchUnlockCoverage > 1)
            throw new client_error_error_1.ClientError(client_error_type_enum_1.ClientErrorType.WrongBatchSize, "getTakerFlowCostForSingleOrder: batchUnlockCoverage should be in range [0.1, 1]");
...
exports.CommonDlnClient = CommonDlnClient;
