...
exports.CrosschainForwarderABI = void 0;
exports.CrosschainForwarderABI = [
    ...
    { inputs: [], name: "NotSupportedRouter", type: "error" },
    { inputs: [], name: "SignatureInvalidV", type: "error" },
    {
        inputs: [{ internalType: "address", name: "srcTokenOut", type: "address" }],
        name: "SwapEmptyResult",
        type: "error",
    },
    { inputs: [{ internalType: "address", name: "srcRouter", type: "address" }], name: "SwapFailed", type: "error" },
    ...
    },
    {
        anonymous: false,
        inputs: [
            { indexed: false, internalType: "address", name: "srcSwapRouter", type: "address" },
    ...
    {
        inputs: [{ internalType: "contract IDeBridgeGateExtended", name: "_deBridgeGate", type: "address" }],
        name: "initialize",
        outputs: [],
        stateMutability: "nonpayable",
        type: "function",
    ...
    },
    {
        inputs: [
            ...
            { internalType: "bytes", name: "_srcTokenInPermitEnvelope", type: "bytes" },
            {
                components: [
    ...
    },
    {
        inputs: [
            ...
            { internalType: "uint256", name: "_srcAmountIn", type: "uint256" },
            { internalType: "bytes", name: "_srcTokenInPermitEnvelope", type: "bytes" },
            { internalType: "uint256", name: "_affiliateFeeAmount", type: "uint256" },
            { internalType: "address", name: "_affiliateFeeRecipient", type: "address" },
            {
                components: [
                    { internalType: "uint256", name: "chainId", type: "uint256" },
                    { internalType: "address", name: "receiver", type: "address" },
    ...
    },
    {
        inputs: [
            ...
            { internalType: "uint256", name: "_srcTokenExpectedAmountOut", type: "uint256" },
            { internalType: "address", name: "_srcTokenRefundRecipient", type: "address" },
        ...
        inputs: [
            ...
            { internalType: "bytes", name: "_srcTokenInPermitEnvelope", type: "bytes" },
            {
                components: [
                    ...
                    { internalType: "uint256", name: "tokenOutExpectedAmount", type: "uint256" },
                    { internalType: "address", name: "tokenOutRefundRecipient", type: "address" },
                ],
...
//# sourceMappingURL=CrossChainForwarder.js.map